---
layout: default
title : "Communication non violente, nouveau totalitarisme"
tags : societe
---
...
## SCÈNE 1 : Le café - Humiliation directe sans CNV
...
## SCÈNE 5 : Le café, quelques jours plus tard - Le triomphe
...
## GÉNÉRIQUE : Points de réflexion

**TEXTE DÉFILANT** :

**Ce scénario illustre comment un outil de communication bienveillante peut être détourné :**

1. **L'asymétrie de l'exigence**
   - Le manipulateur peut être agressif, méprisant, menteur
   - La victime doit rester parfaitement "CNV" même pour se défendre

2. **La neutralisation de la défense légitime**
   - Nommer un mensonge = "jugement non-CNV"
   - Se défendre = "réaction toxique"
   - Les faits objectifs sont disqualifiés

3. **Le retournement victimaire**
   - Le manipulateur n'utilise PAS la CNV dans ses attaques
   - Mais INVOQUE la CNV pour se victimiser après
   - "Il m'a traité de menteur" devient plus grave que le mensonge lui-même

4. **L'institution complice malgré elle**
   - Les référents CNV, de bonne foi, deviennent l'arme du manipulateur
   - Le système devient une bureaucratie morale
   - Les preuves sont ignorées au profit du "ressenti"

5. **Le silence généralisé**
   - Les témoins se taisent par peur d'être la prochaine cible
   - Impossible de créer une coalition
   - Chacun est isolé face au système
...
### Ton général
- Réaliste, sans caricature excessive
- Le manipulateur doit sembler "normal" et même sympathique aux yeux des autres
- La référente CNV doit être sincère et professionnelle (pas méchante, juste aveuglée par sa méthode)

### Casting
- **Le Manipulateur** : Charismatique, souriant, à l'aise en société
- **Les Victimes** : Personnes normales, pas particulièrement faibles
- **La Référente CNV** : Bienveillante, professionnelle, convaincue de bien faire
- **Les Collègues témoins** : Mal à l'aise mais silencieux

### Ambiances
- **Scène 1 (café)** : Décontractée, lumière naturelle
- **Scène 2 (réunion)** : Tension croissante, lumière froide
- **Scène 3 (bureau CNV)** : Faussement apaisante, citations murales
- **Scène 4 (sanction)** : Isolement, lumière glauque
- **Scène 5 (triomphe)** : Retour à la "normalité", le manipulateur règne

### Musique
- Neutre au début
- Légèrement oppressante lors des confrontations
- Silence pesant lors de la scène avec la référente
- Ironique/amère à la fin